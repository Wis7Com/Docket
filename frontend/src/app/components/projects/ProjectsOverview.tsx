...
import { Plus, FolderOpen, ChevronDown, Loader2 } from "lucide-react";
                ...
                {loading ? (
                    ...
                    <div className="flex flex-col items-start py-24 w-full max-w-xs mx-auto">
                        ...
                        <p className="mt-1 text-xs text-gray-400 max-w-xs">
                            Open a project folder, or create an empty
                            project and add documents later.
                        </p>
                        <button
                            onClick={handleOpenFolder}
                            disabled={openFolderBusy}
                        ...
                        <button
                            onClick={() => setModalOpen(true)}
                            className="mt-2 inline-flex items-center gap-1 rounded-full border border-gray-200 px-3 py-1 text-xs font-medium text-gray-600 hover:bg-gray-50 transition-colors"
                        >
                            + Create Empty
                        </button>
                    </div>
