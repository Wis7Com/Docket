...
import { Download, Eye, EyeOff, FileDown, FolderMinus, Hash, History, Pencil, RefreshCw, Trash2, Upload } from "lucide-react";
...
export function RowActions({ onDelete, onHide, onUnhide, onDownload, onExportAnnotated, onRescan, onRemoveFromFolder, onShowAllVersions, onUploadNewVersion, deleting, onRename, onUpdateCmNumber }: Props) {
        ...
        <>
            ...
            {open && (
                ...
                >
                    ...
                    {onExportAnnotated && (
                        <button
                            data-session-check="row-export-annotated"
                            onClick={() => { setOpen(false); onExportAnnotated(); }}
                            className="flex items-center gap-2 w-full px-3 py-2 text-xs text-gray-600 hover:bg-gray-50 transition-colors"
                        >
