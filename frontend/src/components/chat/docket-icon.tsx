            ...
            >
                <defs>
                    ...
                    <clipPath id={m.topClip}>
                        <rect x="80" y="-70" width="78" height="140" />
                    </clipPath>
                    {/* One 50° annular segment of the Docket aperture ring
                        (outer R150, inner R95); six copies form the mark. */}
                    <path
                        id={m.blade}
                        d="M 135.95,-63.39 A 150,150 0 0 1 135.95,63.39 L 86.1,40.15 A 95,95 0 0 0 86.1,-40.15 Z"
                    />
                </defs>
